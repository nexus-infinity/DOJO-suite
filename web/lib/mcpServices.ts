...
export const FIELD_MCP_SERVICES: MCPService[] = [
  ...
  { id: 'github',             name: 'GitHub',             symbol: '⬡',  chamber: 'dojo',   category: 'field-tier2', description: 'Client-managed GitHub MCP; historical local FIELD server retained as disabled lineage', authType: 'token', clientExposed: false, routingNote: 'No canonical FIELD listener; official client-managed GitHub MCP only' },
