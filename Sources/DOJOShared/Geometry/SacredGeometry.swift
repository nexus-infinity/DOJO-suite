...
public struct SacredGeometry {
    ...
    public static let kingsChamberFrequency: Float = 852.0  // Third Eye - King's Chamber
    ...
    public static let kingsChamberPosition: Float = 0.382  // King's Chamber (golden ratio)
    ...
    @available(*, deprecated, message: "Use GeometricShape enum")
    public static let crosshairsCircleShape = "⊗"    // King's Chamber
}
